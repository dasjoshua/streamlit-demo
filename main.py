...
def countDays():
    ...
    counts_df.colums = ['Weather', 'Count']
...
choice = st.sidebar.selectbox('Select a parameter', ('temp_min', 'temp_max'))
...
plot_height = st.sidebar.slider('Select the height of the plot', 200, 500, 300)
